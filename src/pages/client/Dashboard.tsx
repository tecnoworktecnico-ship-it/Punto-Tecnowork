...
const ClientDashboard = () => {
  const { user, profile, signOut, loading: sessionLoading, refreshProfile } = useSession();
  ...
  const handlePullToRefresh = useCallback(async () => {
    ...
    try {
      // Refrescar perfil (si es necesario) y datos del dashboard
  ...
  }, [refreshProfile, fetchUserPoints, fetchFeaturedRewards]);
