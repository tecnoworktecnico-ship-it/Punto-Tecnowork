  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-primary-blue to-purple-600 animate-gradient-move text-text-on-color">
      <div className="text-center bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        <h1 className="text-4xl font-bold mb-4 text-text-carbon">Bienvenido, {profile?.first_name || user?.email}!</h1>
        <p className="text-xl text-gray-600 mb-6">Este es tu dashboard de cliente.</p>
