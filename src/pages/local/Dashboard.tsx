        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              <p className="text-xl text-gray-600">{localInfo?.name || 'Local'}</p>
              {localInfo?.can_edit_prices && (
                <Badge className="bg-primary-blue">Precios Personalizables</Badge>
              )}
              {localInfo?.has_photo_print && (
                <Badge variant="outline" className="text-secondary-yellow border-secondary-yellow">
                  Impresión de Fotos
                </Badge>
              )}
            </div>
