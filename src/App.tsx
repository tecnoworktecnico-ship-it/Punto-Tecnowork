...
const App = () => (
  <React.Fragment> {/* Este es el único elemento raíz devuelto por App */}
    ...
    {/* Toaster y Sonner son ahora hermanos de la cadena de proveedores,
        pero aún dentro del único React.Fragment devuelto por App. */}
    <Toaster />
    <Sonner />
  </React.Fragment>
);
